...
function randomAnswer(answersArr) {
    ...
    return function () {
        if (copy.length < 1) { copy = Array.from(answersArr); }
...
async function getData() {
    ...
    const response = await axios.get(`https://opentdb.com/api.php?amount=1&category=${params[0]}&difficulty=${params[1]}&type=multiple`);
